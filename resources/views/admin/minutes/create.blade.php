...
@section('content')
	...
	<div id="page-wrapper">
	    ...
	    <div class="container-fluid">
	        ...
	        <div class="row">
	            <div class="col-lg-12">
	            	<div class="alert alert-warning pull-right">Proyecto: {{ $project->name }}</div>
	                <h1 class="page-header">{{ $title = trans('minutes.minutecreate_title') }}</h1>
	                ...
	                <ol class="breadcrumb">
	                    ...
	                    <li>
	                        <i class="fa fa-file-text-o"></i>  <a href="{{ route('admin.minutes.index', $id) }}">{{ trans('minutes.minute_title') }}</a>
	                    </li>
	                     <li class="active">
        	...
        	{!! Form::open(['route' => 'admin.minutes.store', 'method' => 'POST', 'class' => 'form-horizontal js-frm']) !!}
		        <div class="row">
		            <div class="col-md-7">
		            	...
		            	@include('partials.messages')
							...
							@include('admin.minutes.partials.fields')
