...
@section('content')
	...
	<div id="page-wrapper">
	    ...
	    <div class="container-fluid">
	        ...
	        <div class="row">
	            <div class="col-lg-12">
	                <h1 class="page-header">{{ $title = trans('projects.projectedit_title') }} {{ $project->name }} <span class="pull-right"><a href="{{ route('admin.projects.create') }}" class="btn btn-success">Agregar Proyecto</a></span></h1>
	                <ol class="breadcrumb">
	                    <li>
        	...
        	{!! Form::model($project, ['route' => ['admin.projects.update', $project->id], 'method' => 'PUT', 'class' => 'form-horizontal']) !!}
		        <div class="row">
		            <div class="col-md-7">
